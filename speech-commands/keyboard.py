...
grammarCfg = {
    ...
    "<any_char>": "%(any_char)s",
    "<modifierSingle> <any_char>": "{%(modifierSingle)s:down}%(any_char)s{%(modifierSingle)s:up}",
    "<modifier1> <modifier2> <any_char>": Key("%(modifier1)s:down") + Key("%(modifier2)s:down") + Text("%(any_char)s") + Key("%(modifier2)s:up") + Key("%(modifier1)s:down") ,
    "<keys>": "{%(keys)s}",
